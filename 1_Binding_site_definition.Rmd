...
Define_Binding_Sites <- function(pureclip, bw_plus, bw_minus, windowsize, out){
  ...
  ### TODO MB
  ### this is nice for an internal control!
  ### it allows you to test if there is any strand specific problem in the peak/
  ### binding site processing step. But for a final script and output binding
  ### sites should be merged into one file for better visualization in IGV and 
  ### import/ export by other scripts
  ### I would also suggest to have the export of the final .bed files separated 
  ### from the function core. 
  ### 
