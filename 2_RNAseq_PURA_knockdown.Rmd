...
colnames(htseq_matrix) <- c("kd1", "kd2", "kd3", "kd4", "oe1", "oe2", "oe3", "oe4", "wt1", "wt2", "wt3", "wt4")


condition_all <- c(rep("kd",4), rep("oe",4), rep("wt",4))
sampleReplicate <- rep(paste("Rep",1:4, sep = "_"),3)
